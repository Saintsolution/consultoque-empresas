      ...
      <div className="container-app py-14">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-display text-xl font-extrabold">CONSULTOQUE</p>
                <p className="text-xs text-white/60">Consulta num toque</p>
              </div>
            </div>
            <p className="mt-4 text-sm leading-relaxed text-white/70">
              Telemedicina 24 horas por dia. Consultas imediatas, receitas e
              atestados digitais aceitos, com o respaldo da legislação
              brasileira.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              <li>
                <Link to="/" className="text-white/75 hover:text-mint-400">
                  Início
                </Link>
              </li>
              <li>
                <Link to="/#beneficios" className="text-white/75 hover:text-mint-400">
                  Telemedicina
                </Link>
              </li>
              <li>
                <Link to="/#planos" className="text-white/75 hover:text-mint-400">
                  Planos
                </Link>
              </li>
              <li>
                <Link to="/formcoletivo" className="text-white/75 hover:text-mint-400">
                  Inscrição Coletiva
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-white/10 pt-6">
          <div className="flex flex-col items-center justify-between gap-3 text-center text-xs text-white/50 sm:flex-row sm:text-left">
            <p>
              © {new Date().getFullYear()} CONSULTOQUE — Consulta num toque.
              Todos os direitos reservados.
            </p>
            <p>
              Ao enviar formulários de inscrição, você concorda com os{' '}
              <span className="text-white/70">Termos de Adesão</span>.
            </p>
          </div>
        </div>
      </div>
